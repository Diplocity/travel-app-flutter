...
Widget icons(onCancelPressed) {
  return Row(
    children: <Widget>[
      Expanded(
        child: iconButton(
            Icons.highlight_off, "Skip", Color.fromRGBO(246, 41, 111, 1), () {}),
      ),
      Expanded(
                ...
                children: <Widget>[
                  Container(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          border: Border.all(
                              color: Colors.deepOrange, width: 2.8),
                  ...
                  Text("Postpone", style: TextStyle(color: Colors.deepOrange, fontSize: 13),)
                ],
              )),
        ),
    ],
